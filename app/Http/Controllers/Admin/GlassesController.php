...
public function index(Request $request)
{
    ...
    $query = Glasses::query()
        ->with(['primaryImage', 'donor:id,name,email']); // مفيد لعرض اسم المتبرع بجدول الأدمن
    ...
    return view('admin.glasses.index', compact('glasses')); // ✅ view مخصص للأدمن
}
    /**
...
public function show(Glasses $glasses)
{
    ...
    return view('admin.glasses.show', compact('glasses')); // ✅ view مخصص للأدمن
}
